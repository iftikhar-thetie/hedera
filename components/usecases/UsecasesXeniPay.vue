<template>
  <BaseSection :label="'XeniPay'">
    <template #icon>
      <img :src="XeniPayIcon" class="w-6 h-6 mr-2" />
    </template>
    <template #controls>
...
import XeniPayIcon from '~/assets/icons/xenipay.svg';
...
const accountsChartOptions = computed(() => {
  return {
    chart: {
      id: 'xeni-engaged-accounts-chart'
    },
    xAxis: {
      // type: 'datetime',
    }
